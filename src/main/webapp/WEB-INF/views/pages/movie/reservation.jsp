...
$( document ).ready(function() {
	...
	var mouth = new String((day.getMonth() + 1));
	var getdate = new String(day.getDate());
	if(mouth.length == 1){
		mouth = "0"+mouth;
	}
	if(getdate.length == 1){
	...
	var todate = year+""+mouth+""+getdate;
	var hour = new String(day.getHours());
	var minutes = new String(day.getMinutes());
	if(hour.length == 1){
		hour = "0"+hour;
	}
	if(minutes.length == 1){
			...
			$.ajax({
	            ...
	            success : function(data) {
	            	...
	            	if(data == ""){
	            		...
	            		$("#time_choice").append("<h4 style='text-align:left;'>"+data[0].TT_NAME+" ("+data[0].TT_SEAT+"석)</h4>");
