...
input[class="wh_0"]+label {
	...
	height: 24px;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/zero_wh.png');
	cursor: pointer;
...
input[class="wh_0"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/zero_bl.png');
}
...
input[class="wh_1"]+label {
	...
	height: 24px;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/one_wh.png');
	cursor: pointer;
	border: 0.5px #ECECEC solid;
}
...
input[class="wh_1"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/one_bl.png');
}
...
input[class="wh_2"]+label {
	...
	height: 24px;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/two_wh.png');
	cursor: pointer;
	border: 0.5px #ECECEC solid;
}
...
input[class="wh_2"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/two_bl.png');
}
...
input[class="wh_3"]+label {
	...
	height: 24px;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/three_wh.png');
	cursor: pointer;
	border: 0.5px #ECECEC solid;
}
...
input[class="wh_3"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/three_bl.png');
}
...
input[class="wh_4"]+label {
	...
	height: 24px;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/four_wh.png');
	cursor: pointer;
	border: 0.5px #ECECEC solid;
}
...
input[class="wh_4"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/four_bl.png');
}
...
input[class="wh_5"]+label {
	...
	height: 24px;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/five_wh.png');
	cursor: pointer;
	border: 0.5px #ECECEC solid;
}
...
input[class="wh_5"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/five_bl.png');
}
...
input[class="wh_6"]+label {
	...
	height: 24px;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/six_wh.png');
	cursor: pointer;
	border: 0.5px #ECECEC solid;
}
...
input[class="wh_6"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/six_bl.png');
}
...
input[class="seat_1"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/one.png');
}

input[class="seat_1"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/one_r.png');
}
...
input[class="seat_2"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/two.png');
}

input[class="seat_2"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/two_r.png');
}
...
input[class="seat_3"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/three.png');
}

input[class="seat_3"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/three_r.png');
}
...
input[class="seat_4"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/four.png');
}

input[class="seat_4"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/four_r.png');
}
...
input[class="seat_5"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/five.png');
}

input[class="seat_5"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/five_r.png');
}
...
input[class="seat_6"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/six.png');
}

input[class="seat_6"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/six_r.png');
}
...
input[class="seat_7"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/seven.png');
}

input[class="seat_7"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/seven_r.png');
}
...
input[class="seat_8"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/eight.png');
}

input[class="seat_8"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/eight_r.png');
}
...
input[class="seat_9"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/nine.png');
}

input[class="seat_9"]:checked+label {
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/nine_r.png');
}
...
input[class="x"]+label {
	...
	cursor: pointer;
	background-image:
		url('${pageContext.request.contextPath}/static/img/movie/x.png');
}
						...
						<div style="padding-top: 15px;">
							...
							<dl style="font-size: 24px;">
								<dt>
									...
									&nbsp; <span id="week"></span> <input type="hidden" id="day"
										value="<fmt:formatDate value="${noticePostDate}" pattern="yyyy.MM.dd"/>">
								</dt>
								<dt>
									&nbsp;
									...
									&nbsp; ~ &nbsp; <input type="hidden" id="st_time"
										value="<fmt:formatDate value="${s_time}" pattern="HH:mm"/>" />
								</dt>
				...
				<div class="col-sm-9" id="seat_div">
					...
					<div class="row">
						...
						<div class="col-sm-8">
							<table id="s_table">
								<c:choose>
									<c:when test="${mv_list['tt_name'] eq '1관'}">
													...
													<c:choose>
														...
														<c:otherwise>
															<td><input type="checkbox" class="seat_${j}"
																name="seat" id="${s_name}" value="${s_name}"
																onClick="item('${s_name}');" /><label for="${s_name}"></label>
									...
									<c:when test="${mv_list['tt_name'] eq '2관'}">
									...
									<c:otherwise>
										...
										<c:forTokens var="i" items="${alphabet}" delims=",">
											<tr>
												<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												<c:forEach var='j' begin='1' end='6' varStatus="index">
													<c:set var="doneLoop" value="false" />
													<c:set var="s_name" value='${i}${j}' />
													<c:if test="${index.first}">
														<td><b>${i}</b>&nbsp;&nbsp;&nbsp;</td>
				...
				<div class="col-sm-12" style="padding: 0;">
					<table id="select_box">
						<tr class="row" id="selects">
							...
							<th class="col-sm-2 box_th" id="c_seat"
								style="text-align: center;">
								<h3 class="box_title">좌석선택</h3>
							</th>
							<th class="col-sm-2 box_th">
								<h5 class="pay">
									성 &nbsp; 인 : <span id="no">0</span> <br /> 청소년 : <span id="yo">0</span>
									<br /> 어린이 : <span id="ki">0</span> <br /> <b
										style="color: red;">합 &nbsp; 계 : </b> <span id="r_price"
										style="color: red;">0</span> <br />
								</h5>
							</th>
							<th class="col-sm-2" id="go_btn"><c:url var="go_pay"
									value="/movie/pay" />
								<form action="${go_pay}" method="post">
									<input type="hidden" name="sd_code" id="sd_code"
										value="${sd_list['SD_CODE']}" /> <input type="hidden"
										name="mv_code" value="${mv_list['mv_code']}" /> <input
										type="hidden" name="mv_title_kr"
										value="${mv_list['mv_title_kr']}" /> <input type="hidden"
										name="c_name" value="${mv_list['c_name']}" /> <input
										type="hidden" name="tt_name" value="${mv_list['tt_name']}" />
									<input type="hidden" name="sd_day" value="${mv_list['sd_day']}" />
									<input type="hidden" name="t_time" value="${mv_list['t_time']}" />
									<input type="hidden" id="week" name="week" /> <input
										type="hidden" name="end_time" /> <input type="hidden"
										name="r_price" />
									<p id="h_inp"></p>
