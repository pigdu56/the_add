...
<body onload="noBack();" onpageshow="if(event.persisted) noBack();"
	...
	<div class="container">
		...
		<img src="${pageContext.request.contextPath}/static/img/bus/s3.png"
			id="want3"> <br>
		<br>
		<br>
					...
					<c:forEach var="i" items="${buy_list}" varStatus="j">
						<div class="col-sm-6"
							...
							<table class="table ticket">
								...
								<tr>
									<td
										style="font-size: 15px; color: #0FA3B9; border-bottom: solid 1px white;"><b>등급</b></td>
									<td
										style="font-size: 15px; color: #0FA3B9; border-bottom: solid 1px white;">&nbsp;&nbsp;&nbsp;<b>버스번호</b></td>
									<td
										style="font-size: 15px; color: #0FA3B9; border-bottom: solid 1px white;"><b>버스좌석</b></td>
								</tr>
